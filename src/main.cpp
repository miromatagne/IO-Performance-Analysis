...
// dans Measurement.cpp uncomment ligne 58 et changer B = 65536 ligne 158
    Measurement *m4 = new Measurement();
     m4->getAverageTimesB2("../data/cast_info.csv", 10, 20000*65536, 32500*65536, 100*65536);
////// END
...
//    m1->testIterations("../data/cast_info.csv", 10, 1000, 10000, 1000);
 // Et celui la pour les 3 fichiers
    //   m1->testFiles2(0);  // faire une fois avec seed = 10 dans la classe Experiment2.h (ligne34)
...
// Et celui la pour les 3 fichiers
    //  m2->testFiles2(0);// faire une fois avec seed = 10 dans la classe Experiment2.h (ligne34)
...
//    m4->testIterations("../data/cast_info.csv", 10, 1000, 10000, 1000);
    // Et celui la pour les 3 fichiers
//    m4->testFiles2(65536);// faire une fois avec seed = 10 dans la classe Experiment2.h (ligne34)
//    m4->testFiles2(65536);  // faire une fois avec seed = 100
// Varier B
