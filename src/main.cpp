...
*/
    ...
    int sum = experiment2.randjump1("../data/aka_title.csv", 8000);
    cout << "sum: " << sum << endl;
    int sum2 = experiment2.randjump2("../data/aka_title.csv", 8000);
    cout << "sum: " << sum2 << endl;
    int sum3 = experiment2.randjump3("../data/aka_title.csv", 8000,2);
    cout << "sum: " << sum3 << endl;
    int sum4 = experiment2.randjump4("../data/aka_title.csv", 8000, 2);
    cout << "sum: " << sum4 << endl;
